...
See the [Migration Guide](/docs/introduction/migration-from-lucid) for detailed comparisons.

## Get Started

Ready to build? Start with [Installation](/docs/introduction/installation) or jump to [Getting Started](/docs/introduction/getting-started).
